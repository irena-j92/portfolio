...
<br />
    ...
    <Image src={project.lastfm_hero} alt="Hero Lastfm" width={900} height={800} objectFit="cover" className="rounded-xl mt-10 mx-auto"
    ...
    whileInView={{opacity: 1}}
    transition={{duration: 0.5, delay: 0.7}}
    className="bg-[#f4f4f4] rounded-xl justify-center items-center w-[450px] md:w-[900px] sm:w-[900px] mx-auto sm:max-w-screen">
    <div className="text-gray-700 max-w-3xl mx-auto space-y-6">
      <br />
          <h3 className='gap-2 text-2xl md:text-2xl mb-2 font-Ovo px-8 sm:px-0 md:px-0 font-semibold text-[#FE2E00]'>Project Overview </h3>
    
        <p className='text-lg lg:text-[15px] mt-6 text-gray-700 leading-relaxed sm:text-[14px] px-8 sm:px-0 md:px-0'>Last.fm is a music platform that creates an online library based on the users’ listening
          habits. The data is transferred or “scrobbled” via a music player of choice (Spotify, Deezer, Tidal, Apple Music etc.) and stored on the user’s
          profile. Users are then given insight on their listening behavior through various stats. The service has been around for over two decades and
          has therefore built a strong and loyal following.</p></div>
    ...
    <h3 className='gap-2 text-2xl md:text-2xl mb-3 mt-8 font-Ovo font-semibold text-[#FE2E00] px-8 sm:px-0 md:px-0'>Project Goals </h3>
        ...
        <p className='text-lg lg:text-[15px] mt-6 leading-relaxed sm:text-[14px] px-8 sm:px-0 md:px-0'>
...
<br />
    ...
    <motion.div
     ...
     whileInView={{opacity: 1}}
    transition={{duration: 0.6, delay: 0.9}}
    className='grid grid-cols-3 sm:grid-cols-5 gap-3 max-w-4xl mx-auto mt-10'>
    <ul className='bg-[#FE2E00] rounded-full px-6 py-4 mt-2 mb-2 text-sm text-[#F4F4F4] gap-2 inline-flex items-center justify-center'><Image src={project.lastfm_empathy} alt="empathize" className='w-5' />01 / Empathize</ul>
    <ul className='bg-[#FE2E00] rounded-full px-6 py-4 mt-2 mb-2 text-sm text-[#F4F4F4] gap-2 inline-flex items-center justify-center'><Image src={project.lastfm_define} alt="define" className='w-5' />02 / Define</ul>
    <ul className='bg-[#FE2E00] rounded-full px-6 py-4 mt-2 mb-2 text-sm text-[#F4F4F4] gap-2 inline-flex items-center justify-center'><Image src={project.lastfm_ideate} alt="ideate" className='w-5' />03 / Ideate</ul>
    <ul className='bg-[#FE2E00] rounded-full px-6 py-4 mt-2 mb-2 text-sm text-[#F4F4F4] gap-2 inline-flex items-center justify-center'><Image src={project.lastfm_proto} alt="prototype" className='w-5' />04 / Prototype</ul>
    <ul className='bg-[#FE2E00] rounded-full px-6 py-4 mt-2 mb-2 text-sm text-[#F4F4F4] gap-2 inline-flex items-center justify-center'><Image src={project.lastfm_test} alt="test" className='w-5' />05 / Test</ul>
    </motion.div>
          ...
          whileInView={{opacity: 1, y: 0}}
          transition={{duration: 0.5, delay: 0.3}}
          className='flex items-end gap-2 text-2xl md:text-2xl mb-3 mt-12 font-Ovo font-semibold text-[#FE2E00]'>01 / Empathize </motion.h3>
          <motion.p
          initial={{opacity: 0, y: -20}}
          whileInView={{opacity: 1, y: 0}}
          transition={{duration: 0.5, delay: 0.3}}
          className='text-lg lg:text-[15px] mt-6 leading-relaxed'>
            ...
            whileInView={{opacity: 1, y: 0}}
            transition={{duration: 0.5, delay: 0.3}}
            className='flex items-end gap-2 text-2xl md:text-2xl mb-3 mt-12 font-Ovo font-semibold'>Direct research</motion.h3>

            <motion.p
            initial={{opacity: 0}}
            whileInView={{opacity: 1}}
            transition={{duration: 0.5, delay: 0.7}}
            className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'>The user demographic for Last.fm is diverse, which prompted me to design
              ...
              whileInView={{opacity: 1}}
              transition={{duration: 0.5, delay: 0.7}}
              className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'>While social features – such as the ability to communicate with others
                ...
                className='grid grid-cols-2 sm:grid-cols-4 gap-6 items-center'>
                  <div className='bg-[#FE2E00] rounded-full px-8 py-8 mb-4 mt-4 sm:mb-8 sm:mt-8'>
                <ul className='text-center text-white text-5xl sm:text-lg lg:text-[48px] md:text-2xl mb-2 mt-8 font-Ovo'>80%</ul>
                <ul className='text-center text-sm text-white mb-6'>active in the <br />creative field</ul>
                  </div>

                  <div className='bg-[#FE2E00] rounded-full px-8 py-8 mb-4 mt-4 sm:mb-8 sm:mt-8'>
                <ul className='text-center text-white text-5xl sm:text-lg lg:text-[48px] md:text-2xl mb-2 mt-8 font-Ovo'>20-60</ul>
                <ul className='text-center text-sm text-white mb-6'>participants' <br />age range</ul>
                  </div>

                  <div className='bg-[#FE2E00] rounded-full px-8 py-8 mb-4 mt-4 sm:mb-8 sm:mt-8'>
                <ul className='text-center text-white text-5xl sm:text-lg lg:text-[48px] md:text-2xl mb-2 mt-8 font-Ovo'>90%</ul>
                <ul className='text-center text-sm text-white mb-6'>participants <br />use Spotify</ul>
                  </div>

                  <div className='bg-[#FE2E00] rounded-full px-8 py-8 mb-8 mt-8'>
                <ul className='text-center text-white text-5xl sm:text-lg lg:text-[48px] md:text-2xl mb-2 mt-8 font-Ovo'>2-21</ul>
              ...
              whileInView={{opacity: 1, y: 0}}
              transition={{duration: 0.5, delay: 0.3}}
              className='flex items-end gap-2 text-2xl md:text-2xl mb-3 mt-12 font-Ovo font-semibold'>Indirect research</motion.h3> 

              <motion.p
              initial={{opacity: 0, y: -20}}
              whileInView={{opacity: 1, y: 0}}
              transition={{duration: 0.5, delay: 0.3}}
              className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'><b>While the direct research provided valuable insights into the target
              ...
              <motion.p
               ...
               whileInView={{opacity: 1, y: 0}}
               transition={{duration: 0.5, delay: 0.7}}
               className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'>This deep attachment reflects a broader desire among the community to see the platform thrive.
        ...
        <br />
              ...
              whileInView={{opacity: 1, y: 0}}
              transition={{duration: 0.5, delay: 0.3}}
              className='flex items-end gap-2 text-2xl md:text-2xl mb-3 mt-12 font-Ovo font-semibold text-[#FE2E00]'>02 / Define </motion.h3>
              <motion.p
              initial={{opacity: 0}}
              whileInView={{opacity: 1}}
              transition={{duration: 0.5, delay: 0.7}}
              className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'>The first persona is a synthesis of the insights gathered through both
        ...
        whileInView={{opacity: 1}}
        transition={{duration: 0.6, delay: 0.9}}>
        <Image src={project.lastfm_brad} alt="Brad" width={1280} height={800} objectFit="cover" className="rounded-lg mx-auto" onContextMenu={(e) => e.preventDefault()} />
        </motion.div>
        ...
        whileInView={{opacity: 1, y: 0}}
        transition={{duration: 0.5, delay: 0.3}}
        className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'>Although the youngest participant in the study was 20 years old, I chose to also
        ...
        whileInView={{opacity: 1}}
        transition={{duration: 0.5, delay: 0.7}}
        className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'><b>Last.fm operates in a competitive landscape alongside various music streaming,
    ...
    whileInView={{opacity: 1, y: 0}}
    transition={{duration: 0.5, delay: 0.3}}
    className='flex items-end gap-2 text-2xl md:text-2xl mb-3 mt-12 font-Ovo font-semibold'>Feature Roadmap</motion.h3>
    
    <motion.p
    initial={{opacity: 0}}
    whileInView={{opacity: 1}}
    transition={{duration: 0.5, delay: 0.7}}
    className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'><b>I compiled a list of proposed features and organized them in a prioritized
    ...
    whileInView={{opacity: 1, y: 0}}
    transition={{duration: 0.5, delay: 0.3}}
    className='flex items-end gap-2 text-2xl md:text-2xl mb-3 mt-12 font-Ovo font-semibold text-[#FE2E00]'>03 / Ideate </motion.h3>
    ...
    whileInView={{opacity: 1}}
    transition={{duration: 0.5, delay: 0.7}}
    className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'>I began ideating by sketching early concepts on my iPad. These initial
  ...
  transition={{duration: 0.6, delay: 0.9}}>
   ...
   onContextMenu={(e) => e.preventDefault()} /></motion.div>
      ...
      <br />
        ...
        whileInView={{opacity: 1, y: 0}}
        transition={{duration: 0.5, delay: 0.3}}
        className='flex items-end gap-2 text-2xl md:text-2xl mb-3 mt-12 font-Ovo font-semibold'>User Flow</motion.h3>
        <motion.p
        initial={{opacity: 0}}
        whileInView={{opacity: 1}}
        transition={{duration: 0.5, delay: 0.7}}
        className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'><b>A key principle in the user flow design was minimizing cognitive load by
    ...
    whileInView={{opacity: 1, y: 0}}
    transition={{duration: 0.5, delay: 0.3}}
    className='flex items-end gap-2 text-2xl md:text-2xl mb-3 mt-12 font-Ovo font-semibold text-[#FE2E00]'>04 / Prototype </motion.h3>
    <motion.p
    initial={{opacity: 0}}
    whileInView={{opacity: 1}}
    transition={{duration: 0.5, delay: 0.7}}
    className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'>Through user research, I discovered a clear preference for dark mode interfaces,
    ...
    className='grid grid-cols-2 gap-20 justify-between'>
      <ul className='text-7xl sm:text-5xl lg:text-[120px] font-Poppins text-[#FE2E00]'>Poppins</ul>

      <div className="flex flex-col items-end sm:text-right mx-auto">
      <ul className='bg-gray-200 rounded-lg px-3 py-3 text-sm text-gray-700 font-bold mt-4'>FONT FAMILY</ul>
      <ul className='sm:text-lg sm:text-gray-400 mt-10'>Regular • Medium • Semibold • Bold</ul>
      </div>
    ...
    <Image src={project.lastfm_logo} alt="Logo" width={1280} height={800} objectFit="cover" className="rounded-lg mx-auto" onContextMenu={(e) => e.preventDefault()} />
    </motion.div>
    ...
    <ul className='bg-[#FE2E00] rounded-full px-6 py-6 text-white text-center'>#FE2E00</ul>
    <ul className='bg-[#FF782A] rounded-full px-6 py-6 text-center'>#FF782A</ul>
    <ul className='bg-[#FFCA7C] rounded-full px-6 py-6 text-center'>#FFCA7C</ul>
    <ul className='bg-[#DBC29D] rounded-full px-6 py-6 text-center'>#DBC29D</ul>
    <ul className='bg-[#232323] rounded-full px-6 py-6 text-[#ffffff] text-center'>#232323</ul>
    <ul className='bg-[#F4F4F4] border border-[#ABABAB] text-gray-700 rounded-full px-6 py-6 text-center'>#F4F4F4</ul>
    </motion.div>
    <br />
    ...
    whileInView={{opacity: 1}}
    transition={{duration: 0.5, delay: 0.7}}
    className='flex items-end gap-2 text-2xl md:text-2xl mb-3 font-Ovo font-semibold'>Wireframes</motion.h3>
    <motion.p
   initial={{opacity: 0}}
   whileInView={{opacity: 1}}
   transition={{duration: 0.6, delay: 0.9}}
   className='tsm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'><b>Guided by the feature roadmap and user flow, I developed wireframes that highlight
    ...
    className="flex items-center justify-center mx-auto mt-10 rounded-xl"
...
className='flex items-end gap-2 text-2xl md:text-2xl mb-3 mt-12 font-Ovo font-semibold text-[#FE2E00]'>05 / Test</motion.h3>
   ...
   initial={{opacity: 0}}
    whileInView={{opacity: 1}}
    transition={{duration: 0.5, delay: 0.7}}
    className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'><b>The first version of the app didn't have the central button that takes you 
    ...
    whileInView={{opacity: 1, y: 0}}
    transition={{duration: 0.5, delay: 0.3}}
    className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'><b>In the first app version I have also worked on another three sections: 
    ...
    whileInView={{opacity: 1}}
    transition={{duration: 0.5, delay: 0.7}}
    className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'>The playlist section was a little bit confusing for the user, so I took it out 
    ...
    whileInView={{opacity: 1, y: 0}}
    transition={{duration: 0.5, delay: 0.3}}
    className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'>During my research I then stumbled upon a lot of 
    ...
    whileInView={{opacity: 1}}
    transition={{duration: 0.5, delay: 0.7}}
    className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'>I have created the following 12 personality types: <b>The Snooper</b> - finding secret gems is their speciality, <b>The Evergreen</b> - listens to classics, 
    ...
    whileInView={{opacity: 1}}
    transition={{duration: 0.6, delay: 0.9}}
    className='sm:text-lg lg:text-[15px] text-lg mt-6 leading-relaxed'>I also explored different types of skins since it was a frequent requested feature but
