  ...
  return (
    <div id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
        Welcome to my UI/UX portfolio! Explore a collection of projects
        showcasing my expertise in UI/UX design and front-end development.
      </p>

      <div className='grid grid-cols-3 my-10 gap-5 dark:text-black'>
        {workData.map((project, index) => (
         <Link href={`/pages/${project.id}`} key={index}>
            <div
